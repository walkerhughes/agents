...
| [`rbac-todo`](plugins/rbac-todo/) | Personal Supabase Postgres to-dos with browser sign-in, admin writes and member reads, served by an Edge Function using mcp-lite. | yes |
...
| [`safeway`](plugins/safeway/) | Safeway's public website: nearby stores, store-scoped products and prices, shopping lists, and menu planning (4 tools). | yes |
